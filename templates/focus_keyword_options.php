...
<fieldset class="screen-options">
    ...
    <input type="checkbox" name="focus_keyword_options[show_date]" id="show_date" <?=$show_date ? 'checked' : ''?>/>
    <label for="show_date">Show the post publish date </label>
    <input type="hidden" name="focus_keyword_options[show_traffic]" value="off"/>
    <input type="checkbox" name="focus_keyword_options[show_traffic]" id="show_traffic" <?=$show_traffic ? 'checked' : ''?>/>
    ...
    <input type="checkbox" name="focus_keyword_options[remove_obviated_keywords]" id="remove_obviated_keywords" <?=$remove_obviated_keywords ? 'checked' : ''?>/>
...
<fieldset class="screen-options">
    ...
    <input type="number" step="1" min="1" max="999" maxlength="3" name="focus_keyword_options[per_page]" id="per_page" value="<?=esc_attr($per_page)?>" />
</fieldset>
<br>
<?=$button?>
