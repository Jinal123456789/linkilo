...
<fieldset class="screen-options">
    ...
    <?php if(!empty(Linkilo_Build_GoogleSearchConsole::is_authenticated())){ ?>
    <input type="checkbox" name="report_options[show_traffic]" id="show_traffic" <?=$show_traffic ? 'checked' : ''?> <?= 'links' !== $report ? $hide : ''?>/>
    <label for="show_traffic" <?= 'links' !== $report ? $hide : ''?>>Show the organic traffic&nbsp;&nbsp;&nbsp;</label>
    <?php } ?>
