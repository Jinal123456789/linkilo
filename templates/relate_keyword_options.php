...
<fieldset class="screen-options">
    ...
    <input type="checkbox" name="linkilo_keyword_options[hide_select_links_column]" id="hide_select_links_column" <?=$hide_select_links ? 'checked' : ''?>/>
    <label for="hide_select_links_column">Hide Possible Links Column?&nbsp;&nbsp;&nbsp;</label>
</fieldset>
<fieldset class="screen-options">
    <legend>Pagination</legend>
    <label for="per_page">Posts per page</label>
    <input type="number" step="1" min="1" max="999" maxlength="3" name="linkilo_keyword_options[per_page]" id="per_page" value="<?=esc_attr($per_page)?>" />
</fieldset>
<br>
<?=$button?>
