...
(function ($) {
    $(document).on('change', '#linkilo_links_table_filter select', linkilo_report_filter);
    ...
    function linkilo_report_filter_submit() {
        ...
        var url = admin_url + 'admin.php?page=linkilo&type=links' + orphaned + '&filter_type=' + filterType;
